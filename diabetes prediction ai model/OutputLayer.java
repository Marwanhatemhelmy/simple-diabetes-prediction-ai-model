...
class OutputLayer{
    ...
    // this function is used in rare and special cases to reset momentums
    public void resetMomentumes(){
        this.firstMomentumW.clear();;
        this.secondMomentumW.clear();
        this.firstMomentumB.clear();
        this.secondMomentumB.clear();
    }
